    ...
    <div class="col-md-3">
      ...
      <div class="box box-primary">
        <div class="box-body box-profile">
          ...
          <a href="/user/swimclasses/bookip/<?php echo $courses['id']; ?>"><button type="button" class="btn btn-xs btn-block btn-primary">In progress</button></a>
        ...
        <div class="box-body no-padding">
          ...
          <table class="table">
            ...
            <tr>
              ...
              <td><?php echo $course['spaces'] - count($course['coursegroup']['students']); ?></td>
            </tr>
          <?php
}?>
          </table>
