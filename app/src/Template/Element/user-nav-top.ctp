<?php
$file = 'src' . DS . 'Template' . DS . 'Element' . DS . 'user-nav-top.ctp';
            ...
            <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="user-footer">
                        <div class="pull-left">
                            <a href="/user/users/profile/<?php echo $this->request->session()->read('Auth.User.id'); ?>" class="btn btn-default btn-flat">Profile</a>
                        </div>
                        <div class="pull-right">
                            <a href="/user/users/logout" class="btn btn-default btn-flat">Sign out</a>
                        </div>
                    </li>
                </ul>
            </li>
