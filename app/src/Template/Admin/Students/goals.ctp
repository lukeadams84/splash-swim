...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/admin/students/profile/<?php echo $studentid; ?>">Student Profile</a></li>
            ...
            <div class="tab-content">
              ...
              <div class="<?php if($index == 0) { echo "active"; } ?> tab-pane" id="<?php echo $achievement['id']; ?>">
                <div class="box-body no-padding">
                        ...
                        <td>
                          <?php
                            if(!empty($goal['students'])) {
                              ...
                              <a href="/admin/students/completegoal/<?php echo $studentid;?>/<?php echo $goal['id'];?>"><button type="button" class="btn btn-xs btn-block btn-primary">Mark achieved</button></a>
                            <?php }
                          ?></td>
                      </tr>
                    <?php } } ?>
                  ...
                  ?>
                  <a href="/admin/students/completeachievement/<?php echo $studentid;?>/<?php echo $achievement['id'];?>"><button type="button" class="btn btn-xs btn-block btn-primary">Mark achieved</button></a>
                <?php } elseif ($progress == 100 && !empty($achievement['students'])) { ?>
