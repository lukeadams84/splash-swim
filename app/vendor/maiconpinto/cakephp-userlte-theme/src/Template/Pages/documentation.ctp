...
<section id="introduction">
  ...
  <p class="lead">
    <b>UserLTE</b> is a popular open source WebApp template for admin dashboards and control panels.
    It is a responsive HTML template that is based on the CSS framework Bootstrap 3.
    It utilizes all of the Bootstrap components in its design and re-styles many
    commonly used plugins to create a consistent design that can be used as a user
    interface for backend applications. UserLTE is based on a modular design, which
...
<section id="download">
  ...
  <p class="lead">
    UserLTE can be downloaded in two different versions, each appealing to different skill levels and use case.
  </p>
  <div class="row">
    <div class="col-sm-6">
      <div class="box box-primary">
        ...
        <div class="box-body">
          <p>Compiled and ready to use in production. Download this version if you don't want to customize UserLTE's LESS files.</p>
          <a href="http://almsaeedstudio.com/download/UserLTE-dist" class="btn btn-primary"><i class="fa fa-download"></i> Download</a>
        </div><!-- /.box-body -->
      </div><!-- /.box -->
    </div><!-- /.col -->
    <div class="col-sm-6">
      <div class="box box-danger">
        ...
        <div class="box-body">
          ...
          <a href="http://almsaeedstudio.com/download/UserLTE" class="btn btn-danger"><i class="fa fa-download"></i> Download</a>
        </div><!-- /.box-body -->
      </div><!-- /.box -->
    </div><!-- /.col -->
  </div><!-- /.row -->
...
<section id="dependencies">
  ...
  <p class="lead">UserLTE depends on two main frameworks.
...
<section id="advice">
  ...
  <ul>
    <li><b>UserLTE is based on <a href="http://getbootstrap.com/" target="_blank">Bootstrap 3</a>.</b> If you are unfamiliar with Bootstrap, visit their website and read through the documentation. All of Bootstrap components have been modified to fit the style of UserLTE and provide a consistent look throughout the template. This way, we guarantee you will get the best of UserLTE.</li>
    ...
    <li><b>Documentation.</b> We are trying our best to make your experience with UserLTE be smooth. One way to achieve that is to provide documentation and support. If you think that something is missing from the documentation, please do not hesitate to create an issue to tell us about it. Also, if you would like to contribute, email the support team at <a href="mailto:support@almsaeedstudio.com">support@almsaeedstudio.com</a>.</li>
    ...
    <li><b>Hosted on <a href="https://github.com/almasaeed2010/UserLTE/" target="_blank">GitHub</a>.</b> Visit our GitHub repository to view issues, make requests, or contribute to the project.</li>
  </ul>
  <p>
...
<section id="layout">
  ...
  <p class="lead">UserLTE 2.0 provides a set of options to apply to your main layout. Each on of these classes can be added
...
<section id="UserLTE-options">
  <h2 class="page-header"><a href="#UserLTE-options">UserLTE Javascript Options</a></h2>
  <p class="lead">Modifying the options of UserLTE's app.js can be done using one of the following ways.</p>

  <h3>Editing app.js</h3>
  <p>Within the main Javascript file, modify the <code>$.UserLTE.options</code> object to suit your use case.</p>

  <h3>Defining UserLTEOptions</h3>
  <p>Alternatively, you can define a global options variable named <code>UserLTEOptions</code> and initialize it before loading app.js.</p>
  <p>Example</p>
...
&LT;script src="dist/js/app.js" type="text/javascript">&LT;/script></code></pre>
  ...
  <h3>Available UserLTE Options</h3>
...
<section id="components" data-spy="scroll" data-target="#scrollspy-components">
  ...
  <div class="callout callout-info lead">
    <h4>Reminder!</h4>
    <p>
      UserLTE uses all of Bootstrap 3 components. It's a good start to review
...
&LT;/div>&LT;!-- /.main-sidebar --></pre>
  ...
  these methods can be set through the <a href="#UserLTE-options">Javascript options</a>.</p>
...
&LT;div class="box box-solid box-danger">...&LT;/div></pre>
  ...
  <p class="lead">Boxes can contain tools to deploy a specific event or provide simple info. The following examples makes use
    of multiple UserLTE components within the header of the box.</p>
  <p>UserLTE data-widget attribute provides boxes with the ability to collapse or be removed. The buttons
...
<section id="plugins">
  ...
  <p class="lead">UserLTE makes use of the following plugins. For documentation, updates or license information, please visit the provided links.</p>
...
<section id="browsers">
  ...
  <p class="lead">UserLTE supports the following browsers:</p>
  <ul>
    <li>IE9+</li>
...
<section id="upgrade">
  ...
  <h3>New Files</h3>
  <p>Make sure you update all CSS and JS files that are related to UserLTE. Otherwise, the layout will not
    function properly. Most important files are UserLTE.css, skins CSS files, and app.js.</p>
...
<section id="implementations">
  ...
  <p class="lead">Thanks to many of UserLTE users, there are multiple implementations of the template
  for easy integration with back-end frameworks. The following are some of them:</p>

  <ul>
    <li><a href="https://github.com/mmdsharifi/UserLTE-RTL">Persian RTL</a> by <a href="https://github.com/mmdsharifi">Mohammad Sharifi</a></li>
    <li><a href="https://github.com/dmstr/yii2-UserLTE-asset" target="_blank">Yii 2</a> by <a href="https://github.com/schmunk42" target="_blank">Tobias Munk</a></li>
    ...
    <li>Rails gems: <a href="https://github.com/nicolas-besnard/UserLTE2-rails" target="_blank">UserLTE2-rails</a> by <a href="https://github.com/nicolas-besnard" target="_blank">Nicolas Besnard</a> and <a href="https://github.com/racketlogger/lte-rails" target="_blank">lte-rails</a> (using UserLTE sources) by <a href="https://github.com/racketlogger" target="_blank">Carlos at RacketLogger</a></li>
  </ul>

  <p><b class="text-red">Note:</b> these implementations are not supported by Almsaeed Studio. However,
    they do provide a good example of how to integrate UserLTE into different frameworks. For the latest release
    of UserLTE, please visit our <a href="https://github.com/almasaeed2010/UserLTE">repository</a> or <a href="https://almsaeedstudio.com">website</a></p>
</section>
...
<section id="faq">
  ...
  <h3>Can UserLTE be used with Wordpress?</h3>
  <p class="lead">UserLTE is an HTML template that can be used for any purpose. However, it is not made to be easily installed on Wordpress. It will require some effort and enough knowledge of the Wordpress script to do so.</p>

  <h3>Is there an integration guide for PHP frameworks such as Yii or Symfony?</h3>
  <p class="lead">Short answer, no. However, there are forks and tutorials around the web that provide info on how to integrate with many different frameworks. There are even versions of UserLTE that are integrated with jQuery ajax, AngularJS and/or MVC5 ASP .NET.</p>

  <h3>How do I get notified of new UserLTE versions?</h3>
  <p class="lead">The best option is to subscribe to our mailing list using the <a href="http://almsaeedstudio.com/#subscribe">subscription form on Almsaeed Studio</a>.
    If that's not appealing to you, you may watch the <a href="https://github.com/almasaeed2010/UserLTE">repository on Github</a> or visit <a href="http://almsaeedstudio.com">Almsaeed Studio</a> every now and then for updates and announcements.</p>
</section>
...
<section id="license">
  ...
  <h3>UserLTE</h3>
  <p class="lead">
    UserLTE is an open source project that is licensed under the <a href="http://opensource.org/licenses/MIT">MIT license</a>.
