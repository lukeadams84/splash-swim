...
$this->Html->css([
    ...
    'UserLTE./plugins/iCheck/all',
    'UserLTE./plugins/colorpicker/bootstrap-colorpicker.min',
    'UserLTE./plugins/timepicker/bootstrap-timepicker.min',
    'UserLTE./plugins/select2/select2.min',
  ],
  ['block' => 'css']);

$this->Html->script([
  'UserLTE./plugins/select2/select2.full.min',
