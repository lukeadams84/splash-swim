...
<html>
  <head>
    ...
    <title><?php echo isset($theme['title']) ? $theme['title'] : 'UserLTE 2 | Documentation'; ?></title>
    ...
    <?php echo $this->Html->css('UserLTE.documentation'); ?>
  ...
  <body class="skin-blue fixed" data-spy="scroll" data-target="#scrollspy">
    ...
    <aside class="main-sidebar">
        ...
        <div class="sidebar" id="scrollspy">
          ...
          <ul class="nav sidebar-menu">
            ...
            <li><a href="#UserLTE-options"><i class="fa fa-circle-o"></i> Javascript Options</a></li>
    ...
    <?php echo $this->Html->script('UserLTE.documentation'); ?>
  </body>
</html>
